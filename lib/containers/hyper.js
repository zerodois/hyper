...
class Hyper extends React.PureComponent {
  ...
  render() {
    const {isMac: isMac_, customCSS, uiFontFamily, borderColor, maximized, fullScreen, backgroundColor} = this.props;
    ...
    return (
      <div id="hyper">
        <div
          ...
          className={`hyper_main ${(isMac_ || isLinux) && 'hyper_mainRounded'} ${fullScreen ? 'fullScreen' : ''}`}
        >
          <HeaderContainer />
